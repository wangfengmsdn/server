...
const char *client_errors[]=
{
  ...
  "Can't connect to local MariaDB server through socket '%-.100s' (%M)",
  "Can't connect to MariaDB server on '%-.100s' (%M)",
  "Can't create TCP/IP socket (%M)",
  "Unknown MariaDB server host '%-.100s' (%d)",
  ...
  "Malformed packet",
  "This client library is licensed only for use with MariaDB servers having '%s' license",
  ...
  "Lost connection to MariaDB server at '%s', system error: %M",
